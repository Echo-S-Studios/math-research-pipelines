...
DOI 10.5281/zenodo.21121863 (v1.0.0); this bundle is intended for the
deposit's next version (paper, section 9).

## Integrity

    sha256sum -c SHA256SUMS        # 10 artifacts, all must report OK
