...
(the complete artifact set as of v1.0.2, version DOI
\url{10.5281/zenodo.21123586}, in the \texttt{relational-charge-verification/}
package alongside this manuscript), enabling verification by a distinct operator. Concretely (expected
...
results (twenty-four signatures, two factorization checks).\\[2pt]
