...
(added in v1.0.1, in the \texttt{relational-charge-verification/} package
alongside this manuscript), enabling verification by a distinct operator. Concretely (expected
