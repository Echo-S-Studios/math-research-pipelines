...
Reciprocal-seed floor (Salem, units) & Open (no uniform floor) & Rem~\ref{rem:threshold} \\
...
\begin{enumerate}[label=(O\arabic*),leftmargin=*]
  ...
  \item \textbf{The reciprocal-seed floor.} A uniform positive Mahler floor is a theorem only for
        non-reciprocal seeds (Smyth); the reciprocal case---Salem numbers and units, which arise naturally as
        seeds---is the unsolved core of Lehmer's problem, and the gate is honest that it has no proven floor
        there.
  ...
  \item \textbf{The conformal constant $c$ \emph{(reframed: a declared scale with a critical--point--native
        canonicalization).}} With $\lambda=2c$ the only residual freedom is $c$, and by \v{C}encov's theorem it is
        irreducible \emph{within} information geometry---no invariance argument fixes the scale~\cite{Cencov}
        (Remark~\ref{rem:cencov}). Three readings of the field's own structure name three values
